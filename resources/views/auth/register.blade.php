        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                    ...
                    @component('auth.common.consent')
                    @endcomponent

                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-4">
                            @if (!empty($guest))
                                <button type="submit" name="guest-submit" value="guest" id="guest-button" class="btn btn-primary">Continue as Guest</button>
                            @else
