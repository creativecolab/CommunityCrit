            ...
            <a class="panel-link" href="{{ action('TaskController@singleSource', $source->slug) }}">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">{{ $source->name }}<span class="viewComments pull-right"><span class="glyphicon glyphicon-comment" data-state="off" aria-hidden="true"></span><span class="commentCount">{{ $source->feedback->count() }}</span></span></div>
                    </div> <!-- .panel-heading -->
