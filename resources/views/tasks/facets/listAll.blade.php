            ...
            <a class="panel-link" href="{{ action('TaskController@singleFacet', $facet->slug) }}">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">{{ $facet->name }}<span class="viewComments pull-right"><span class="glyphicon glyphicon-comment" data-state="off" aria-hidden="true"></span><span class="commentCount">17</span></span></div>
                    </div> <!-- .panel-heading -->
