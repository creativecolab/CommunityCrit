...
@section('content')
    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <p>The Master Plan for the 14th Street Promenade, which extends from City College to the intersection at National Ave, approved by the Downtown Community Planning Council in June 2016. With the goal of creating a more sustainable, walkable downtown, the Promenade will feature widened sidewalks, outdoor seating, and art in order to promote social gathering and community expression.</p>
            <p>Community leaders are currently engaging the public and local experts to design additions to this project. They are using this platform to get your help in forming ideas around developing the intersection of 14th St and National Ave, known as El Nudillo, and activating dead spaces along 14th St. Select an option below to get started!</p>
            ...
            <p>How does it work? It includes feedback activities based on your interests and available time. This input will be shared with the sponsors, designers, and community members to help shape the ultimate plan.</p>
        </div> <!-- .col -->
        <div class="col-md-3">
            <figure>
