...
class LinksSeeder extends Seeder
{
	public $data = [
        ...
        [
            ...
            'image' => '0',
            'link_type' => '1',
            'text' => '<strong>14th Street Promenade Workshop: Key Concepts</strong><br>
                        <b>Respect Neighborhood Scale</b></p>
        ...
        [
            ...
            'image' => '0',
            'link_type' => '1',
            'text' => '<strong>East Village South Draft Focus Plan: Define a Unique Neighborhood</strong><br>
                        <b>Lighting:</b><br>
                        <ul>
        ...
        [
            ...
            'image' => '0',
            'link_type' => '2',
            'text' => '<strong>East Village South Draft Focus Plan: Enhance Livability through Public Open Space</strong><br>
        ...
        [
            ...
            'image' => '0',
            'link_type' => '5',
            'text' => 'There are so many beautiful murals at Chicano Park that celebrate the heritage of the surrounding community. I wonder if local artists might be willing to decorate whatever ends up being built at El Nudillo in a similar way?',
            'idea_id' => '2',
            'user_id' => '3',
            'hidden' => '0',
        ],
